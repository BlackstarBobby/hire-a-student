                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="panel-body">
                            ...
                            <a href="{{route('job.applicate', ['companyJob' => $job->id])}}" class="btn btn-default">Apply
                                For This Job</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="panel-body">
                            ...
                            @if($job->company->facebook)
                                <a href="{{$job->company->facebook}}" target="blank" class="user-media"><i
                                            class="fa fa-facebook"></i></a>
                            @endif

                            @if($job->company->twitter)
                                <a href="{{$job->company->twitter}}" target="blank" class="user-media twitter"><i
                                            class="fa fa-twitter"></i></a>
                            @endif

                            @if($job->company->linkedin)
                                <a href="{{$job->company->linkedin}}" target="blank" class="user-media linke"><i
                                            class="fa fa-linkedin"></i></a>
                            @endif

                            @if($job->company->google_plus)
                                <a href="{{$job->company->google_plus}}" target="blank" class="user-media google"><span
